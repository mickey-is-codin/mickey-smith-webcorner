...
const Index: React.FC = (props) => {
  const postsLink = <a href="/posts" className="text-white hover:text-green-500">things I've written</a>
  const sitesLink = <a href="/sites" className="text-white hover:text-green-500">sites I like</a>;
  const projectsLink = <a href="/projects" className="text-white hover:text-green-500">things I've made</a>;
    ...
    <PageContainer>
      ...
      <div className="flex bg-themeBlack-2 rounded-lg my-8 p-8">
        ...
        <div className="flex-1 my-auto text-center">
          {/* <h2>I wanted to create a personal site that embodies what the internet means to me.</p> */}
